...
commands = [
'export PYTHONIOENCODING=utf-8',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 1 -e 10000 >> scripts/batch/log/batch_00.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 10001 -e 20000 >> scripts/batch/log/batch_01.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 20001 -e 30000 >> scripts/batch/log/batch_02.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 30001 -e 40000 >> scripts/batch/log/batch_03.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 40001 -e 50000 >> scripts/batch/log/batch_04.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 50001 -e 60000 >> scripts/batch/log/batch_05.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 60001 -e 70000 >> scripts/batch/log/batch_06.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 70001 -e 80000 >> scripts/batch/log/batch_07.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 80001 -e 90000 >> scripts/batch/log/batch_08.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 90001 -e 100000 >> scripts/batch/log/batch_09.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 100001 -e 110000 >> scripts/batch/log/batch_10.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 110001 -e 120000 >> scripts/batch/log/batch_11.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 120000 -e 520001 >> scripts/batch/log/batch_12.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 520001 -e 560000 >> scripts/batch/log/batch_13.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 560001 -e 600000 >> scripts/batch/log/batch_14.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 600001 -e 640000 >> scripts/batch/log/batch_15.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 640001 -e 680000 >> scripts/batch/log/batch_16.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 680001 -e 720000 >> scripts/batch/log/batch_17.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 720001 -e 760000 >> scripts/batch/log/batch_18.log 2>&1',
'node --max-old-space-size=2500 dist/scripts/Non-Lambda/Page-Categorizer-Universal.js -s 760001 -e 1000000 >> scripts/batch/log/batch_19.log 2>&1',
