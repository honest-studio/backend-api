...
/**
 * Credentials for Google Analytics API
 */
export interface GoogleAnalyticsConfig {
    /**
     * Universal Analytics Client ID for Google Analytics
     */
     ...
     * Has to be generated by a user with access to the Google Analytics dashboard
     */
     ...
     * Google API Client Secret
     * Has to be generated by a user with access to the Google Analytics dashboard
     * The user has to go through the OAuth user flow at /v2/oauth/google-analytics and it will return a refresh token
     */
    googleApiRefreshToken: string;
    /**
     * Google API Redirect URI
     * Must be set in the Google Developers Console
     */
