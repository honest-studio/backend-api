...
export class HomepageService {
    ...
    async getAMPHomepage(@Res() res, lang_code: string): Promise<any> {
        ...
        const [
            ...
            this.statService.editorLeaderboard({ offset: 0, period: 'today', lang: langToUse, cache: true, sortby: 'iq', limit: 8 }),
            this.statService.editorLeaderboard({ offset: 0, period: 'this-week', lang: langToUse, cache: true, sortby: 'iq', limit: 8 }),
            this.statService.editorLeaderboard({ offset: 0, period: 'this-month', lang: langToUse, cache: true, sortby: 'iq', limit: 8 }),
            this.statService.editorLeaderboard({ offset: 0, period: 'all-time', lang: langToUse, cache: true, sortby: 'iq', limit: 8 }),
            this.statService.editorLeaderboard({ offset: 0, period: 'today', lang: langToUse, cache: true, sortby: 'edits', limit: 8 }),
            this.statService.editorLeaderboard({ offset: 0, period: 'this-week', lang: langToUse, cache: true, sortby: 'edits', limit: 8 }),
            this.statService.editorLeaderboard({ offset: 0, period: 'this-month', lang: langToUse, cache: true, sortby: 'edits', limit: 8 }),
            this.statService.editorLeaderboard({ offset: 0, period: 'all-time', lang: langToUse, cache: true, sortby: 'edits', limit: 8 }),
            this.statService.editorLeaderboard({ offset: 0, period: 'today', lang: langToUse, cache: true, sortby: 'votes', limit: 8 }),
            this.statService.editorLeaderboard({ offset: 0, period: 'this-week', lang: langToUse, cache: true, sortby: 'votes', limit: 8 }),
            this.statService.editorLeaderboard({ offset: 0, period: 'this-month', lang: langToUse, cache: true, sortby: 'votes', limit: 8 }),
            this.statService.editorLeaderboard({ offset: 0, period: 'all-time', lang: langToUse, cache: true, sortby: 'votes', limit: 8 }),
        ]);
